const results = [
  ...
  { id: 11, name: "Example apps", category: "User Management"},
  { id: 12, name: "Magic Auth", category: "User Management"},
  { id: 13, name: "Users and Organizations", category: "User Management"},
  { id: 14, name: "AuthKit", category: "User Management"},
  { id: 15, name: "Multi-Factor Authentication", category: "User Management"},
  { id: 16, name: "Organization Authentication Policies", category: "User Management"},
  { id: 17, name: "Configuring a domain", category: "User Management", subCat1: "Email Domains"},
  { id: 18, name: "Migrate from another service", category: "User Management", subCat1: "Migrating to User Management"},

  //* - MIGRATIONS - *//

  { id: 19, name: "Migrate from the standalone SSO API", category: "Migrations"},
  { id: 20, name: "Migrate from Auth0", category: "Migrations"},
  { id: 21, name: "Migrate from AWS Cognito", category: "Migrations"},
  { id: 22, name: "Migrate users from another service", category: "Migrations", subCat1: "Migrate to WorkOS"},
  { id: 23, name: "Exporting Auth0 user data", category: "Migrations", subCat1: "Migrate from Auth0"},

  //* - SINGLE SIGN-ON - *//

  { id: 24, name: "Example apps", category: "Single Sign-On"},
  { id: 25, name: "Choose your integration approach", category: "Single Sign-On", subCat1: "Single Sign-On"},
