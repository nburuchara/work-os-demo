                ...
                >
                    <div id="top" className="demo-docs-container">
                        <div style={{width: sidebarMenuClicked ? "63%" : "auto", float: sidebarMenuClicked ? "right" : "none", marginBottom: sidebarMenuClicked ? "1%" : "4%", paddingBottom: sidebarMenuClicked ? "5%" : "5%", borderBottom: "1.3px solid #6363f1"}} className='demo-docs-section' >
                            ...
                            <p style={{fontSize: sidebarMenuClicked ? "90%" : "100%", marginBottom: "0px", color: "#5e626a"}}>Respond to activity that occurs within WorkOS and third-party providers.</p>
                ...
                >
                    <div id="top" className="demo-docs-container">
                        <div style={{width: sidebarMenuClicked ? "63%" : "auto", float: sidebarMenuClicked ? "right" : "none", marginBottom: sidebarMenuClicked ? "1%" : "4%", paddingBottom: sidebarMenuClicked ? "5%" : "5%", borderBottom: "1.3px solid #6363f1"}} className='demo-docs-section' >
                            ...
                            <p style={{fontSize: sidebarMenuClicked ? "90%" : "100%", marginBottom: "0px", color: "#5e626a"}}>A step-by-step guide on how to start syncing data using the API.</p>
                        ...
                        <div style={{width: sidebarMenuClicked ? "63%" : "auto", float: sidebarMenuClicked ? "right" : "none", marginBottom: sidebarMenuClicked ? "1%" : "4%", paddingBottom: sidebarMenuClicked ? "2.5%" : "5%", borderBottom: "1.3px solid #6363f1"}} className='demo-docs-section'><i id="Migrating from webhooks"></i>
                ...
                >
                    <div id="top" className="demo-docs-container">
                        <div style={{width: sidebarMenuClicked ? "63%" : "auto", float: sidebarMenuClicked ? "right" : "none", marginBottom: sidebarMenuClicked ? "1%" : "4%", paddingBottom: sidebarMenuClicked ? "5%" : "5%", borderBottom: "1.3px solid #6363f1"}} className='demo-docs-section' >
                            ...
                            <p style={{fontSize: sidebarMenuClicked ? "90%" : "100%", marginBottom: "0px", color: "#5e626a"}}>A step-by-step guide on how to start syncing data using webhooks.</p>
                            <div style={{paddingBottom: sidebarMenuClicked ? "3.5%" : ""}} id="What you’ll build"></div>
                        </div>
                        <div style={{width: sidebarMenuClicked ? "63%" : "auto", float: sidebarMenuClicked ? "right" : "none", marginBottom: sidebarMenuClicked ? "1%" : "4%", paddingBottom: sidebarMenuClicked ? "2.5%" : "5%"}} className='demo-docs-section'>
                        ...
                        <div style={{width: sidebarMenuClicked ? "63%" : "auto", float: sidebarMenuClicked ? "right" : "none", marginBottom: sidebarMenuClicked ? "1%" : "4%", paddingBottom: sidebarMenuClicked ? "2.5%" : "5%"}} className='demo-docs-section'>
                            ...
                            <div style={{marginTop: "5%"}} className='testing-the-api-info-box'>
                                ...
                                <div className='api-info-box-text'>
                                    <div className="api-keys">
                                        <p style={{fontSize: sidebarMenuClicked ? "64.5%" : "65%", marginTop: sidebarMenuClicked ? "1%" : "1.3%", marginRight: "2%"}}>WorkOS sends the header as <span style={{backgroundColor: "#ccc"}}>WorkOS-Signature</span>, but many web servers normalize HTTP request headers to their lowercase variants<i id="Register your endpoint"></i>.</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div style={{width: sidebarMenuClicked ? "63%" : "auto", float: sidebarMenuClicked ? "right" : "none", marginBottom: sidebarMenuClicked ? "1%" : "4%", paddingBottom: sidebarMenuClicked ? "2.5%" : "5%"}} className='demo-docs-section'>
                            ...
                            <p className={sidebarMenuClicked ? "demo-docs-section-sidebar-p" : ""}>In order to avoid unnecessary retry requests hitting your webhook handler, we recommend using two concurrent processes for handling events:<i id="Respond with HTTP 200 OK"></i> one for receiving the event, and the other for processing it.</p>
                        
                            <h3 className={sidebarMenuClicked ? "demo-docs-section-sidebar-h3" : ""}>Respond with HTTP 200 OK</h3>

                            <div className="api-keys">
                                <p className={sidebarMenuClicked ? "demo-docs-section-sidebar-p" : ""}>On receiving an event, you should respond with an HTTP 200 OK to signal to WorkOS that the event was successfully delivered. Otherwise, WorkOS will consider the event delivery a failure and retry up to 12 times, with exponential backoff over 3 days. You do not need to signal to WorkOS whether or <i id="Validate the requests using the SDK"></i>not the event was processed successfully.</p>
                            </div>
                            ...
                            <p className={sidebarMenuClicked ? "demo-docs-section-sidebar-p" : ""}>There is an optional parameter, tolerance, that sets the time validation for the webhook in seconds. The SDK methods <i id="Validate the requests manually"></i>have default values for tolerance, usually 3 – 5 minutes.</p>
                            ...
                            <p className={sidebarMenuClicked ? "demo-docs-section-sidebar-p" : ""}>Once you’ve determined the event request is validly signed, it’s safe <i id="Create an IP allowlist"></i>to use the event payload in your application’s business logic.</p>
                        ...
                        <div style={{width: sidebarMenuClicked ? "63%" : "auto", float: sidebarMenuClicked ? "right" : "none", marginBottom: sidebarMenuClicked ? "1%" : "4%", paddingBottom: sidebarMenuClicked ? "2.5%" : "5%", borderBottom: "1.3px solid #6363f1"}} className='demo-docs-section'><i id="Respond to events immediately"></i>
                            ...
                            <p className={sidebarMenuClicked ? "demo-docs-section-sidebar-p" : ""}>A common pattern is to store the request payload on a message queue, respond with a 200 OK response, and use a <i id="Recover from failed events"></i>background worker to process the messages in the queue.</p>
                            ...
                            <div style={{marginTop: "5%"}} className='testing-the-api-info-box'>
                                ...
                                <div className='api-info-box-text'>
                                    <div className="api-keys">
                                        <p style={{fontSize: sidebarMenuClicked ? "64.5%" : "65%", marginTop: sidebarMenuClicked ? "1%" : "1.3%", marginRight: "2%"}}>In staging environments, WorkOS only retries failed webhooks for several minutes before giving up. You can, however, manually <i id="Handle out-of-sequence events"></i>retry webhooks using the WorkOS Dashboard for these environments.</p>
                                    </div>
                                </div>
                            </div>
