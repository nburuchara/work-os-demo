...
const results = [
    ...
    {id: "999968", name: "WorkOS will redirect to your Redirect URI if there is an issue generating an authorization URL. Read our API Reference for more details.", category: "User Management", page: "Quick Start", lastCat: "You can use the optional state"},

    {id: "999967", name: "Next, let’s add the callback endpoint (referenced in Configure a redirect URI) which will exchange the authorization code (valid for 10 minutes) for an authenticated User object.", category: "User Management", page: "Quick Start", lastCat: "WorkOS will redirect"},

    {id: "999966", name: "Navigate to the authentication endpoint we created and sign up for an account. You can then sign in with the newly created credentials and see the user listed in the Users section of the WorkOS Dashboard", category: "User Management", page: "Quick Start", lastCat: "WorkOS will redirect"},

    {id: "999965", name: "There are two ways to integrate session management with WorkOS:", category: "User Management", page: "Quick Start", lastCat: "Handle the user session"},
    {id: "999964", name: "If using the authkit-nextjs library, session management is handled for you. No further integration is required.", category: "User Management", page: "Quick Start", lastCat: "For illustration purposes"},

    {id: "999963", name: "In order to persist the authenticated state of the user in the application, we need to store and access a session.", category: "User Management", page: "Quick Start", lastCat: "For illustration purposes" },

    {id: "999962", name: "For illustration purposes we’ll be using a JSON Web Token (JWT) to store the authenticated user in a short lived cookie, though your approach may differ depending on the application's specific requirements.", category: "User Management", page: "Quick Start", lastCat: "For illustration purposes"},
