                    ...
                    >
                        <div id='top' className='demo-docs-container'>    
                            <div style={{width: sidebarMenuClicked ? "63%" : "auto", float: sidebarMenuClicked ? "right" : "none", marginBottom: sidebarMenuClicked ? "1%" : "4%", paddingBottom: sidebarMenuClicked ? "5%" : "5%", borderBottom: "2px solid #6363f1"}} className='demo-docs-section' >
                                ...
                                <p style={{fontSize: sidebarMenuClicked ? "90%" : "100%", marginBottom: "0px", color: "#5e626a"}}>Easy to authenticate APIs designed to provide a flexible, secure, and fast integration.</p>
                            ...
                            <div style={{width: sidebarMenuClicked ? "63%" : "auto", float: sidebarMenuClicked ? "right" : "none", marginBottom: sidebarMenuClicked ? "1%" : "4%", paddingBottom: sidebarMenuClicked ? "5%" : "7.5%"}} className='demo-docs-section'>
                                ...
                                <p className={sidebarMenuClicked ? "demo-docs-section-sidebar-p" : ""}>Let's add the necessary dependencies and configuration in your WorkOS Dashboard.</p>
