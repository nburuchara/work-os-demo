const codeSnippets = [
    ...
    { //* Secure route with middleware
      ...
      code: {
        javascript: [
          ...
          '<span style="color: #8b8d98;">22</span>   <span style="color: #148a68;">const</span> hasValidSession <span style="color: #ce3559;">=</span> <span style="color: #148a68;">await</span> <span style="color: #5854c6;">verifyAccessToken</span>(session.accessToken);',
          '<span style="color: #8b8d98;">23</span> ',
          '<span style="color: #8b8d98;">24</span>   <span style="color: #8b8d98;">// If the session is valid, move on to the next function</span>',
          '<span style="color: #8b8d98;">25</span>   <span style="color: #148a68;">if</span> (hasValidSession) {',
          '<span style="color: #8b8d98;">26</span>     <span style="color: #148a68;">return</span> <span style="color: #5854c6;">next</span>();',
          '<span style="color: #8b8d98;">27</span>   }',
          '<span style="color: #8b8d98;">28</span> ',
          '<span style="color: #8b8d98;">29</span>   <span style="color: #148a68;">try</span> {',
          '<span style="color: #8b8d98;">30</span>     <span style="color: #8b8d98;">// If the session is invalid (i.e. the access token has expired)</span>',
          '<span style="color: #8b8d98;">31</span>     <span style="color: #8b8d98;">// attempt to re-authenticate with the refresh token</span>',
          '<span style="color: #8b8d98;">32</span>     <span style="color: #148a68;">const</span> { accessToken, refreshToken } <span style="color: #ce3559;">=</span>',
          '<span style="color: #8b8d98;">33</span>       <span style="color: #148a68;">await</span> workos.userManagement.<span style="background-color: #f5f5ff; color: #6e6bce; padding: 0.2%; border-radius: 5px;" onmouseover="this.style.textDecoration=\'underline\'; this.style.cursor=\'pointer\';" onmouseout="this.style.textDecoration=\'none\';">authenticateWithRefreshToken</span>({',
          '<span style="color: #8b8d98;">34</span>         clientId,',
          '<span style="color: #8b8d98;">35</span>         refreshToken<span style="color: #ce3559;">:</span> session.refreshToken,',
          '<span style="color: #8b8d98;">36</span>       });',
          '<span style="color: #8b8d98;">37</span> ',
          '<span style="color: #8b8d98;">38</span>     <span style="color: #8b8d98;">// Refresh tokens are single use, so update the session with the</span>',
          '<span style="color: #8b8d98;">39</span>     <span style="color: #8b8d98;">// new access and refresh tokens</span>',
          '<span style="color: #8b8d98;">40</span>     <span style="color: #148a68;">const</span> encryptedSession <span style="color: #ce3559;">=</span> <span style="color: #148a68;">await</span> <span style="color: #5854c6;">sealData</span>(',
          '<span style="color: #8b8d98;">41</span>       {',
          '<span style="color: #8b8d98;">42</span>         accessToken,',
          '<span style="color: #8b8d98;">43</span>         refreshToken,',
          '<span style="color: #8b8d98;">44</span>         user<span style="color: #ce3559;">:</span> session.user,',
          '<span style="color: #8b8d98;">45</span>         impersonator<span style="color: #ce3559;">:</span> session.impersonator,',
          '<span style="color: #8b8d98;">46</span>       },',
          '<span style="color: #8b8d98;">47</span>       { password<span style="color: #ce3559;">:</span> process.env.<span style="color: #0072dd;">WORKOS_COOKIE_PASSWORD</span> },',
          '<span style="color: #8b8d98;">48</span>     );',
          '<span style="color: #8b8d98;">49</span> ',
          '<span style="color: #8b8d98;">50</span>     <span style="color: #8b8d98;">// Update the cookie</span>',
          '<span style="color: #8b8d98;">51</span>     res.<span style="color: #5854c6;">cookie</span>(<span style="color: #143465;">\'wos-session\'</span>, encryptedSession, {',
          '<span style="color: #8b8d98;">52</span>       path<span style="color: #ce3559;">:</span> <span style="color: #143465;">\'/\'</span>,',
          '<span style="color: #8b8d98;">53</span>       httpOnly<span style="color: #ce3559;">:</span> <span style="color: #0072dd;">true</span>,',
          '<span style="color: #8b8d98;">54</span>       secure<span style="color: #ce3559;">:</span> <span style="color: #0072dd;">true</span>,',
          '<span style="color: #8b8d98;">55</span>       sameSite<span style="color: #ce3559;">:</span> <span style="color: #143465;">\'lax\'</span>,',
          '<span style="color: #8b8d98;">56</span>     });',
          '<span style="color: #8b8d98;">57</span> ',
          '<span style="color: #8b8d98;">58</span>     <span style="color: #148a68;">return</span> <span style="color: #5854c6;">next</span>();',
          '<span style="color: #8b8d98;">59</span>   } <span style="color: #148a68;">catch</span> (e) {',
          '<span style="color: #8b8d98;">60</span>     <span style="color: #8b8d98;">// Failed to refresh access token, redirect user to login page</span>',
          '<span style="color: #8b8d98;">61</span>     <span style="color: #8b8d98;">// after deleting the cookie</span>',
          '<span style="color: #8b8d98;">62</span>     res.<span style="color: #5854c6;">clearCookie</span>(<span style="color: #143465;">\'wos-session\'</span>);',
          '<span style="color: #8b8d98;">63</span>     res.<span style="color: #5854c6;">redirect</span>(<span style="color: #143465;">\'/login\'</span>);',
          '<span style="color: #8b8d98;">64</span>   }',
          '<span style="color: #8b8d98;">65</span> }',
          '<span style="color: #8b8d98;">66</span> ',
          '<span style="color: #8b8d98;">67</span> <span style="color: #148a68;">async function</span> <span style="color: #5854c6;">getSessionFromCookie</span>(cookies) {',
          '<span style="color: #8b8d98;">68</span>   <span style="color: #148a68;">const</span> cookie <span style="color: #ce3559;">=</span> cookies[<span style="color: #143465;">\'wos-session\'</span>];',
          '<span style="color: #8b8d98;">69</span> ',
          '<span style="color: #8b8d98;">70</span>   <span style="color: #148a68;">if</span> (cookie) {',
          '<span style="color: #8b8d98;">71</span>     <span style="color: #148a68;">return</span> <span style="color: #5854c6;">unsealData</span>(cookie, {',
          '<span style="color: #8b8d98;">72</span>       password<span style="color: #ce3559;">:</span> process.env.<span style="color: #0072dd;">WORKOS_COOKIE_PASSWORD</span>,',
          ...
          '<span style="color: #8b8d98;">77</span> <span style="color: #148a68;">async function</span> <span style="color: #5854c6;">verifyAccessToken</span>(accessToken) {',
          '<span style="color: #8b8d98;">78</span>   <span style="color: #148a68;">try</span> {',
          '<span style="color: #8b8d98;">79</span>     <span style="color: #148a68;">await</span> <span style="color: #5854c6;">jwtVerify</span>(accessToken, <span style="color: #0072dd;">JWKS</span>);',
          '<span style="color: #8b8d98;">80</span>     <span style="color: #148a68;">return</span> <span style="color: #0072dd;">true</span>;',
          '<span style="color: #8b8d98;">81</span>   } <span style="color: #148a68;">catch</span> (e) {',
          '<span style="color: #8b8d98;">82</span>     <span style="color: #5854c6;">console</span>.<span style="color: #5854c6;">warn</span>(<span style="color: #143465;">\'Failed to verify session:\'</span>, e);',
          '<span style="color: #8b8d98;">83</span>     <span style="color: #148a68;">return</span> <span style="color: #0072dd;">false</span>;',
    ...
    { //* Add middleware to route
      ...
      code: {
        javascript: [
          '<span style="color: #8b8d98;">1</span> <span style="color: #8b8d98;">// Specify the `withAuth` middleware function we defined earlier to protect this route</span>',
          '<span style="color: #8b8d98;">2</span> app.<span style="color: #5854c6;">get</span>(<span style="color: #143465;">\'/dashboard\'</span>, withAuth, <span style="color: #148a68;">async</span> (req, res) <span style="color: #ce3559;">=></span> {',
          '<span style="color: #8b8d98;">3</span>   <span style="color: #148a68;">const</span> session <span style="color: #ce3559;">=</span> <span style="color: #148a68;">await</span> <span style="color: #5854c6;">getSessionFromCookie</span>(req.cookies);',
          '<span style="color: #8b8d98;">4</span> ',
          '<span style="color: #8b8d98;">5</span>   <span style="color: #5854c6;">console</span>.<span style="color: #5854c6;">log</span>(<span style="color: #143465;">`User</span> ${session.user.firstName} <span style="color: #143465;">is logged in`</span>);',
          '<span style="color: #8b8d98;">6</span> ',
          '<span style="color: #8b8d98;">7</span>   <span style="color: #8b8d98;">// ... render dashboard page</span>',
          '<span style="color: #8b8d98;">8</span> });',
        ],
        nodesdk: [
          '<span style="color: #8b8d98;">1</span> <span style="color: #8b8d98;">// Specify the `withAuth` middleware function we defined earlier to protect this route</span>',
