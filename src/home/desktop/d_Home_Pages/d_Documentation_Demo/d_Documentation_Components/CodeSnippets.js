    ...
    { //* Callback endpoint
      ...
      code: {
        ...
        ruby: [
          '1 require "workos"',
          '2 ',
          '3 CLIENT_ID = ENV["WORKOS_CLIENT_ID"]',
          '4 ',
          '5 def callback',
          '6   profile_and_token = WorkOS::SSO.profile_and_token(',
          '7     code: params["code"],',
          '8     client_id: CLIENT_ID',
          '9   )',
          '10 ',
          '11   profile = profile_and_token.profile',
          '12 ',
          '13   # Use the Test Organization ID to get started. Replace it with',
          '14   # the user’s real organization ID when you finish the integration.',
          '15   organization = "org_test_idp"',
          '16 ',
          '17   # Validate that this profile belongs to the organization used for authentication',
          '18   if profile.organization_id != organization',
          '19     render json: {error: "Unauthorized", status: 401}.to_json',
          '20   end',
          '21 ',
          '22   sign_in_and_redirect profile',
          '23 ',
          '24   # Use the information in `profile` for further business logic.',
          '25 end',
        ],
        rails: [
