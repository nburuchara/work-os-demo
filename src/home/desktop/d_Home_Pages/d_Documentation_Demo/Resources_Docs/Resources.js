                ...
                >
                    <div id='top' className='demo-docs-container'>
                        ...
                        <div style={{width: sidebarMenuClicked ? "63%" : "auto", float: sidebarMenuClicked ? "right" : "none", marginBottom: sidebarMenuClicked ? "1%" : "4%", paddingBottom: sidebarMenuClicked ? "5%" : "5%", borderBottom: "1.3px solid #6363f1"}} className='demo-docs-section'>
                            ...
                            <div className='integrationsContainer'>
                                <div style={{width: sidebarMenuClicked ? "48%": "", marginRight: sidebarMenuClicked ? "2%" : ""}} onClick={() => this.goToIntegrations('OneLogin SAML')} className='integrationsCol'>
                                    <div style={{width: sidebarMenuClicked ? "80%" : ""}} className='integrationsText'>
                            ...
                            <div className='integrationsContainer'>
                                <div style={{width: sidebarMenuClicked ? "48%": "", marginRight: sidebarMenuClicked ? "2%" : ""}} onClick={() => this.goToIntegrations('PingOne SAML')} className='integrationsCol'>
                                    <div style={{width: sidebarMenuClicked ? "80%" : ""}} className='integrationsText'>
                            ...
                            <div className='integrationsContainer'>
                                <div style={{width: sidebarMenuClicked ? "48%": "", marginRight: sidebarMenuClicked ? "2%" : ""}} onClick={() => this.goToIntegrations('React Native Expo')} className='integrationsCol'>
                                    <div style={{width: sidebarMenuClicked ? "80%" : ""}} className='integrationsText'>
                            ...
                            <div className='integrationsContainer'>
                                <div style={{width: sidebarMenuClicked ? "48%": "", marginRight: sidebarMenuClicked ? "2%" : ""}} onClick={() => this.goToIntegrations('Salesforce')} className='integrationsCol'>
                                    <div style={{width: sidebarMenuClicked ? "80%" : ""}} className='integrationsText'>
                            ...
                            <div className='integrationsContainer'>
                                <div style={{width: sidebarMenuClicked ? "48%": "", marginRight: sidebarMenuClicked ? "2%" : ""}} onClick={() => this.goToIntegrations('Shibboleth Unsolicited SAML')} className='integrationsCol'>
                                    <div style={{width: sidebarMenuClicked ? "80%" : ""}} className='integrationsText'>
                            ...
                            <div className='integrationsContainer'>
                                <div style={{width: sidebarMenuClicked ? "48%": "", marginRight: sidebarMenuClicked ? "2%" : ""}} onClick={() => this.goToIntegrations('Workday')} className='integrationsCol'>
                                    <div style={{width: sidebarMenuClicked ? "80%" : ""}} className='integrationsText'>
