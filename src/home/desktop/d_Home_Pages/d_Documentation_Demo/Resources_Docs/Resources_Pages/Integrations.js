        ...
        return (
            <Styles>
                ...
                >
                    <div className='demo-docs-container'>
                        <div style={{width: sidebarMenuClicked ? "63%" : "auto", float: sidebarMenuClicked ? "right" : "none", marginBottom: sidebarMenuClicked ? "1%" : "4%", paddingBottom: sidebarMenuClicked ? "5%" : "5%", borderBottom: "1.3px solid #6363f1"}} className='demo-docs-section'>
                            <h1 style={{paddingTop: sidebarMenuClicked ? "1.5%" : "7%", fontSize: sidebarMenuClicked? "120%" : "150%"}}>Oracle SAML</h1>
                            <p style={{fontSize: sidebarMenuClicked ? "90%" : "100%", marginBottom: "0px", color: "#5e626a"}}>Learn how to configure a connection to Oracle via SAML.</p>
                        </div>
                        <div style={{width: sidebarMenuClicked ? "63%" : "auto", float: sidebarMenuClicked ? "right" : "none", marginBottom: sidebarMenuClicked ? "1%" : "4%", paddingBottom: sidebarMenuClicked ? "5%" : "5%"}} className='demo-docs-section'>
                            ...
                            <p className={sidebarMenuClicked ? "demo-docs-section-sidebar-p" : ""}>To create an Oracle SAML connection, you’ll need the Identity Provider Metadata URL that is available from the organization’s Oracle SAML instance.</p>
                        ...
                        <div style={{width: sidebarMenuClicked ? "63%" : "auto", float: sidebarMenuClicked ? "right" : "none", marginBottom: sidebarMenuClicked ? "1%" : "4%", paddingBottom: sidebarMenuClicked ? "5%" : "5%"}} className='demo-docs-section'>
                            ...
                            <div id='img595' className={`enlargable-image-container ${this.state.enlargedImageId === 'img595' ? 'enlarged' : ''}`} onClick={() => this.toggleEnlarged('img595')}>
                                <img  src='/assets/oracle_saml_img1.avif' alt="Enlargable" className="image" />
                            </div>

                            <p className={sidebarMenuClicked ? "demo-docs-section-sidebar-p" : ""}>The ACS URL is the location an Identity Provider redirects its authentication response to. The SP Entity ID is a URI used to identify the issuer of a SAML request, response, or assertion.</p>
                        ...
                        <div style={{width: sidebarMenuClicked ? "63%" : "auto", float: sidebarMenuClicked ? "right" : "none", marginBottom: sidebarMenuClicked ? "1%" : "4%", paddingBottom: sidebarMenuClicked ? "5%" : "5%"}} className='demo-docs-section'>
                            ...
                            <p className={sidebarMenuClicked ? "demo-docs-section-sidebar-p" : ""}>Normally, this will come from the organization’s IT management team when they set up your application’s SAML configuration in their Oracle instance. But, should that not be the case during your setup, here’s how to obtain it.</p>
                        ...
                        <div style={{width: sidebarMenuClicked ? "63%" : "auto", float: sidebarMenuClicked ? "right" : "none", marginBottom: sidebarMenuClicked ? "1%" : "4%", paddingBottom: sidebarMenuClicked ? "5%" : "5%"}} className='demo-docs-section'>
                            ...
                            <p className={sidebarMenuClicked ? "demo-docs-section-sidebar-p" : ""}>Follow the <label className='demo-docs-hyperlink'>Oracle Cloud documentation</label><span className='demo-docs-hyperlink-icon'><img className={ sidebarMenuClicked ? "demo-docs-hyperlink-icon-sidebar-img" : ""} src='/assets/external_link_color.png' alt='no img available'/></span> to create a new SAML application.</p>

                            <p className={sidebarMenuClicked ? "demo-docs-section-sidebar-p" : ""}>Copy and paste the ACS URL and SP Entity ID into the corresponding fields for Service Provider details and configuration.</p>

                            <p className={sidebarMenuClicked ? "demo-docs-section-sidebar-p" : ""}>In the Advanced Settings of the SSO Configuration page, ensure that you select Signed SSO for Assertion and Response, and Include Signing Certificate in Signature.</p>
                        ...
                        <div style={{width: sidebarMenuClicked ? "63%" : "auto", float: sidebarMenuClicked ? "right" : "none", marginBottom: sidebarMenuClicked ? "1%" : "4%", paddingBottom: sidebarMenuClicked ? "5%" : "5%"}} className='demo-docs-section'>
                            ...
                            <div className='api-keys'>
                                ...
                                <p className={sidebarMenuClicked ? "demo-docs-section-sidebar-p" : ""}>Expand the Attribute Configuration section on the SSO Configuration page and add the following 4 required attributes: <span>firstName</span>, <span>lastName</span>, <span>email</span>, and <span>id</span>.</p>
                                ...
                                <ul>
                                    ...
                                    <li><p className={sidebarMenuClicked ? "demo-docs-section-sidebar-p" : ""}></p>A user’s last name → <span>lastName</span></li>
                        ...
                        <div style={{width: sidebarMenuClicked ? "63%" : "auto", float: sidebarMenuClicked ? "right" : "none", marginBottom: sidebarMenuClicked ? "1%" : "4%", paddingBottom: sidebarMenuClicked ? "5%" : "5%", borderBottom: "1.3px solid #6363f1"}} className='demo-docs-section'>
                            ...
                            <p className={sidebarMenuClicked ? "demo-docs-section-sidebar-p" : ""}>Obtain the IdP Metadata URL following the <label className='demo-docs-hyperlink'>instructions from Oracle</label><span className='demo-docs-hyperlink-icon'><img className={ sidebarMenuClicked ? "demo-docs-hyperlink-icon-sidebar-img" : ""} src='/assets/external_link_color.png' alt='no img available'/></span>.</p>

                            <div id='img596' className={`enlargable-image-container ${this.state.enlargedImageId === 'img596' ? 'enlarged' : ''}`} onClick={() => this.toggleEnlarged('img596')}>
                                <img  src='/assets/oracle_saml_img2.avif' alt="Enlargable" className="image" />
                            </div>

                            <p className={sidebarMenuClicked ? "demo-docs-section-sidebar-p" : ""}>Alternatively, you can manually configure the connection by providing the IdP URI (Entity ID), <label className='demo-docs-hyperlink'>IdP SSO URL</label> and X.509 Certificate.</p>

                            <div id='img597' className={`enlargable-image-container ${this.state.enlargedImageId === 'img597' ? 'enlarged' : ''}`} onClick={() => this.toggleEnlarged('img597')}>
                                <img  src='/assets/oracle_saml_img3.avif' alt="Enlargable" className="image" />
                            </div>
                ...
                >
                    <div className='demo-docs-container'>
                        <div style={{width: sidebarMenuClicked ? "63%" : "auto", float: sidebarMenuClicked ? "right" : "none", marginBottom: sidebarMenuClicked ? "1%" : "4%", paddingBottom: sidebarMenuClicked ? "5%" : "5%", borderBottom: "1.3px solid #6363f1"}} className='demo-docs-section'>
                            <h1 style={{paddingTop: sidebarMenuClicked ? "1.5%" : "7%", fontSize: sidebarMenuClicked? "120%" : "150%"}}>PingFederate SAML</h1>
                            <p style={{fontSize: sidebarMenuClicked ? "90%" : "100%", marginBottom: "0px", color: "#5e626a"}}>Learn how to configure a connection to PingFederate via SAML.</p>
                        </div>
                        <div style={{width: sidebarMenuClicked ? "63%" : "auto", float: sidebarMenuClicked ? "right" : "none", marginBottom: sidebarMenuClicked ? "1%" : "4%", paddingBottom: sidebarMenuClicked ? "5%" : "5%"}} className='demo-docs-section'>
                ...
                >
                    <div className='demo-docs-container'>
                        ...
                        <div style={{width: sidebarMenuClicked ? "63%" : "auto", float: sidebarMenuClicked ? "right" : "none", marginBottom: sidebarMenuClicked ? "1%" : "4%", paddingBottom: sidebarMenuClicked ? "5%" : "5%"}} className='demo-docs-section'>
                            ...
                            <p className={sidebarMenuClicked ? "demo-docs-section-sidebar-p" : ""}>To create a PingOne SAML Connection, you’ll need two pieces of information: an <label className='demo-docs-hyperlink'>SP Metadata URL</label> from WorkOS, and an <label className='demo-docs-hyperlink'>IdP Metadata URL</label> from PingOne.</p>
                        ...
                        <div style={{width: sidebarMenuClicked ? "63%" : "auto", float: sidebarMenuClicked ? "right" : "none", marginBottom: sidebarMenuClicked ? "1%" : "4%", paddingBottom: sidebarMenuClicked ? "5%" : "5%"}} className='demo-docs-section'>
                            ...
                            <div id='img632' className={`enlargable-image-container ${this.state.enlargedImageId === 'img632' ? 'enlarged' : ''}`} onClick={() => this.toggleEnlarged('img632')}>
                                    <img  src='/assets/pingone_saml_img1.avif' alt="Enlargable" className="image" />
                            </div>

                            <p className={sidebarMenuClicked ? "demo-docs-section-sidebar-p" : ""}>The SP Metadata link contains a metadata file the organization can use to set up the SAML integration. In PingOne’s case, the SP Metadata URL needs to be set by the organization when configuring your application in their PingOne instance.</p>

                            <p className={sidebarMenuClicked ? "demo-docs-section-sidebar-p" : ""}>Specifically, the SP Metadata URL will need to be set on the SAML Configuration page:</p>

                            <div id='img633' className={`enlargable-image-container ${this.state.enlargedImageId === 'img633' ? 'enlarged' : ''}`} onClick={() => this.toggleEnlarged('img633')}>
                                    <img  src='/assets/pingone_saml_img2.avif' alt="Enlargable" className="image" />
                            </div>
                        ...
                        <div style={{width: sidebarMenuClicked ? "63%" : "auto", float: sidebarMenuClicked ? "right" : "none", marginBottom: sidebarMenuClicked ? "1%" : "4%", paddingBottom: sidebarMenuClicked ? "5%" : "5%"}} className='demo-docs-section'>
                            ...
                            <p className={sidebarMenuClicked ? "demo-docs-section-sidebar-p" : ""}>Next, provide the PingOne IdP Metadata URL.</p>
                        ...
                        <div style={{width: sidebarMenuClicked ? "63%" : "auto", float: sidebarMenuClicked ? "right" : "none", marginBottom: sidebarMenuClicked ? "1%" : "4%", paddingBottom: sidebarMenuClicked ? "5%" : "5%"}} className='demo-docs-section'>
                            ...
                            <p className={sidebarMenuClicked ? "demo-docs-section-sidebar-p" : ""}>In the PingOne Admin Console, select “Applications” (under “Connections”) in the side menu. Then, select your application.</p>

                            <div id='img634' className={`enlargable-image-container ${this.state.enlargedImageId === 'img634' ? 'enlarged' : ''}`} onClick={() => this.toggleEnlarged('img634')}>
                                    <img  src='/assets/pingone_saml_img2.avif' alt="Enlargable" className="image" />
                            </div>
                        ...
                        <div style={{width: sidebarMenuClicked ? "63%" : "auto", float: sidebarMenuClicked ? "right" : "none", marginBottom: sidebarMenuClicked ? "1%" : "4%", paddingBottom: sidebarMenuClicked ? "5%" : "5%"}} className='demo-docs-section'>
                            ...
                            <p className={sidebarMenuClicked ? "demo-docs-section-sidebar-p" : ""}>In the “Attribute Mapping” section of the PingOne SAML app, add the following field-value parameter pairs:</p>

                            <div className='api-keys'>

                                <ul>
                                    <li><p className={sidebarMenuClicked ? "demo-docs-section-sidebar-p" : ""}><span>email</span> → <span>Email Address</span></p></li>
                                    <li><p className={sidebarMenuClicked ? "demo-docs-section-sidebar-p" : ""}><span>firstName</span> → <span>Given Name</span></p></li>
                                    <li><p className={sidebarMenuClicked ? "demo-docs-section-sidebar-p" : ""}><span>id</span> → <span>User ID</span></p></li>
                                    <li><p className={sidebarMenuClicked ? "demo-docs-section-sidebar-p" : ""}><span>lastName</span> → <span>Family Name</span></p></li>
                                </ul>
                            ...
                            <div id='img635' className={`enlargable-image-container ${this.state.enlargedImageId === 'img635' ? 'enlarged' : ''}`} onClick={() => this.toggleEnlarged('img635')}>
                                    <img  src='/assets/pingone_saml_img3.avif' alt="Enlargable" className="image" />
                            </div>
                            ...
                            <div className='api-keys'>
                                ...
                                <p className={sidebarMenuClicked ? "demo-docs-section-sidebar-p" : ""}>Select the <span>+ Add</span> button once. To return the names of all groups a user is a member of, add “groups” in the “Attributes” column mapped to the “Group Names” PingOne attribute. Click “Save”.</p>

                            </div>

                            <div id='img636' className={`enlargable-image-container ${this.state.enlargedImageId === 'img636' ? 'enlarged' : ''}`} onClick={() => this.toggleEnlarged('img636')}>
                                    <img  src='/assets/pingone_saml_img4.avif' alt="Enlargable" className="image" />
                            </div>
                            ...
                            <div className='api-keys'>
                                ...
                                <p className={sidebarMenuClicked ? "demo-docs-section-sidebar-p" : ""}>Add a new <span>groups</span> attribute mapped to the “Group Names” PingOne attribute.</p>
                        ...
                        <div style={{width: sidebarMenuClicked ? "63%" : "auto", float: sidebarMenuClicked ? "right" : "none", marginBottom: sidebarMenuClicked ? "1%" : "4%", paddingBottom: sidebarMenuClicked ? "5%" : "5%"}} className='demo-docs-section'>
                            ...
                            <p className={sidebarMenuClicked ? "demo-docs-section-sidebar-p" : ""}>In the “Configuration” tab, copy the “IdP Metadata URL”. You’ll need this in the next step. Enable the SAML app to allow users to authenticate.</p>

                            <div id='img637' className={`enlargable-image-container ${this.state.enlargedImageId === 'img637' ? 'enlarged' : ''}`} onClick={() => this.toggleEnlarged('img637')}>
                                    <img  src='/assets/pingone_saml_img5.avif' alt="Enlargable" className="image" />
                            </div>
                        ...
                        <div style={{width: sidebarMenuClicked ? "63%" : "auto", float: sidebarMenuClicked ? "right" : "none", marginBottom: sidebarMenuClicked ? "1%" : "4%", paddingBottom: sidebarMenuClicked ? "5%" : "5%", borderBottom: "1.3px solid #6363f1"}} className='demo-docs-section'>
                            ...
                            <div className='labeled-header'>
                                ...
                                <div className='label-desc'>
                                    <h1 className={sidebarMenuClicked ? "demo-docs-section-sidebar-h1" : ""}>Upload IdP Metadata URL</h1>
                                </div>
                            </div>

                            <p className={sidebarMenuClicked ? "demo-docs-section-sidebar-p" : ""}>Finally, upload the IdP Metadata URL you saved earlier in your WorkOS Connection settings. Your Connection will then be linked and good to go!</p>

                            <div id='img638' className={`enlargable-image-container ${this.state.enlargedImageId === 'img638' ? 'enlarged' : ''}`} onClick={() => this.toggleEnlarged('img638')}>
                                    <img  src='/assets/pingone_saml_img6.avif' alt="Enlargable" className="image" />
                            </div>
                ...
                >
                    <div className='demo-docs-container'>
                        ...
                        <div style={{width: sidebarMenuClicked ? "63%" : "auto", float: sidebarMenuClicked ? "right" : "none", marginBottom: sidebarMenuClicked ? "1%" : "4%", paddingBottom: sidebarMenuClicked ? "5%" : "5%"}} className='demo-docs-section'>
                            ...
                            <p className={sidebarMenuClicked ? "demo-docs-section-sidebar-p" : ""}>These instructions are for connecting to Shibboleth using the <label className='demo-docs-hyperlink'>generic SAML 2.0 configuration</label><span className='demo-docs-hyperlink-icon'><img className={ sidebarMenuClicked ? "demo-docs-hyperlink-icon-sidebar-img" : ""} src='/assets/external_link_color.png' alt='no img available'/></span>. If the organization requires the <label className='demo-docs-hyperlink'>UnsolicitedSSOConfiguration</label><span className='demo-docs-hyperlink-icon'><img className={ sidebarMenuClicked ? "demo-docs-hyperlink-icon-sidebar-img" : ""} src='/assets/external_link_color.png' alt='no img available'/></span> instead, please use the Shibboleth <label className='demo-docs-hyperlink'>Unsolicited SAML provider documentation</label><span className='demo-docs-hyperlink-icon'><img className={ sidebarMenuClicked ? "demo-docs-hyperlink-icon-sidebar-img" : ""} src='/assets/external_link_color.png' alt='no img available'/></span>.</p>

                            <p className={sidebarMenuClicked ? "demo-docs-section-sidebar-p" : ""}>Each SSO Identity Provider requires specific information to create and configure a new <label className='demo-docs-hyperlink'>Connection</label>. Often, the information required to create a connection will differ by Identity Provider.</p>

                            <p className={sidebarMenuClicked ? "demo-docs-section-sidebar-p" : ""}>To create a Shibboleth Generic SAML connection, you’ll need the Identity Provider metadata that is available from the organization’s Shibboleth instance.</p>

                            <p className={sidebarMenuClicked ? "demo-docs-section-sidebar-p" : ""}>Start by logging in to your WorkOS dashboard and browse to the “Organizations” tab on the left hand navigation bar.</p>

                            <p className={sidebarMenuClicked ? "demo-docs-section-sidebar-p" : ""}>Select the organization you wish to configure a Shibboleth Generic SAML connection for, and select “Manually Configure Connection” under “Identity Provider”.</p>

                            <div id='img695' className={`enlargable-image-container ${this.state.enlargedImageId === 'img695' ? 'enlarged' : ''}`} onClick={() => this.toggleEnlarged('img695')}>
                                    <img  src='/assets/shibbo_generic_img1.avif' alt="Enlargable" className="image" />
                            </div>

                            <p className={sidebarMenuClicked ? "demo-docs-section-sidebar-p" : ""}>Select “Shibboleth Generic SAML” from the Identity Provider dropdown, enter a descriptive name for the connection, and then select the “Create Connection” button.</p>

                            <div id='img696' className={`enlargable-image-container ${this.state.enlargedImageId === 'img696' ? 'enlarged' : ''}`} onClick={() => this.toggleEnlarged('img696')}>
                                    <img  src='/assets/shibbo_generic_img2.avif' alt="Enlargable" className="image" />
                            </div>
                        ...
                        <div style={{width: sidebarMenuClicked ? "63%" : "auto", float: sidebarMenuClicked ? "right" : "none", marginBottom: sidebarMenuClicked ? "1%" : "4%", paddingBottom: sidebarMenuClicked ? "5%" : "5%"}} className='demo-docs-section'>
                            ...
                            <p className={sidebarMenuClicked ? "demo-docs-section-sidebar-p" : ""}>Once you’ve created your connection, WorkOS provides the <label className='demo-docs-hyperlink'>ACS URL</label>, <label className='demo-docs-hyperlink'>SP Metadata</label> link, and <label className='demo-docs-hyperlink'>SP Entity ID</label>. It’s readily available in your connection settings in the <label className='demo-docs-hyperlink'>WorkOS Dashboard</label><span className='demo-docs-hyperlink-icon'><img className={ sidebarMenuClicked ? "demo-docs-hyperlink-icon-sidebar-img" : ""} src='/assets/external_link_color.png' alt='no img available'/></span>.</p>

                            <div id='img697' className={`enlargable-image-container ${this.state.enlargedImageId === 'img697' ? 'enlarged' : ''}`} onClick={() => this.toggleEnlarged('img697')}>
                                    <img  src='/assets/shibbo_generic_img3.avif' alt="Enlargable" className="image" />
                            </div>

                            <p className={sidebarMenuClicked ? "demo-docs-section-sidebar-p" : ""}>The ACS URL is the location an Identity Provider redirects its authentication response to. The SP Metadata link contains a metadata file that the organization can use to set up the Shibboleth Generic SAML integration.</p>

                            <p className={sidebarMenuClicked ? "demo-docs-section-sidebar-p" : ""}>The SP Entity ID is a URI used to identify the issuer of a SAML request and the audience of a SAML response. In this case, the SP Entity ID is used to communicate that WorkOS will be the party performing SAML requests to the organization’s Shibboleth instance, and that WorkOS is the intended audience of the SAML responses from the Shibboleth instance.</p>
                        ...
                        <div style={{width: sidebarMenuClicked ? "63%" : "auto", float: sidebarMenuClicked ? "right" : "none", marginBottom: sidebarMenuClicked ? "1%" : "4%", paddingBottom: sidebarMenuClicked ? "5%" : "5%"}} className='demo-docs-section'>
                            ...
                            <p className={sidebarMenuClicked ? "demo-docs-section-sidebar-p" : ""}>In order to integrate you’ll need the Shibboleth IdP metadata.</p>

                            <p className={sidebarMenuClicked ? "demo-docs-section-sidebar-p" : ""}>Normally, this information will come from the organization’s IT Management team when they set up your application’s Shibboleth configuration. But, should that not be the case during your setup, here’s how to obtain them.</p>
                        ...
                        <div style={{width: sidebarMenuClicked ? "63%" : "auto", float: sidebarMenuClicked ? "right" : "none", marginBottom: sidebarMenuClicked ? "1%" : "4%", paddingBottom: sidebarMenuClicked ? "5%" : "5%"}} className='demo-docs-section'>
                            ...
                            <p className={sidebarMenuClicked ? "demo-docs-section-sidebar-p" : ""}>Copy and Paste the “ACS URL” and “SP Entity ID” into the corresponding fields for Service Provider details and configuration. For some Shibboleth setups, you can use the metadata found at the SP Metadata link to configure the Shibboleth connection.</p>
                        ...
                        <div style={{width: sidebarMenuClicked ? "63%" : "auto", float: sidebarMenuClicked ? "right" : "none", marginBottom: sidebarMenuClicked ? "1%" : "4%", paddingBottom: sidebarMenuClicked ? "5%" : "5%"}} className='demo-docs-section'>
                            ...
                            <p className={sidebarMenuClicked ? "demo-docs-section-sidebar-p" : ""}>Download the IdP metadata from the Shibboleth instance. Refer to the <label className='demo-docs-hyperlink'>Shibboleth documentation</label><span className='demo-docs-hyperlink-icon'><img className={ sidebarMenuClicked ? "demo-docs-hyperlink-icon-sidebar-img" : ""} src='/assets/external_link_color.png' alt='no img available'/></span> for more information on this metadata file. Keep in mind where the file was saved, as we’ll be uploading it later to configure the Connection.</p>
                        ...
                        <div style={{width: sidebarMenuClicked ? "63%" : "auto", float: sidebarMenuClicked ? "right" : "none", marginBottom: sidebarMenuClicked ? "1%" : "4%", paddingBottom: sidebarMenuClicked ? "5%" : "5%"}} className='demo-docs-section'>
                            ...
                            <div className='api-keys'>
                                ...
                                <p className={sidebarMenuClicked ? "demo-docs-section-sidebar-p" : ""}>At a minimum, the Attribute Statement in the SAML Response should include <span>id</span>, <span>email</span>, <span>firstName</span>, and <span>lastName</span> attributes. Refer to the <label className='demo-docs-hyperlink'>Shibboleth documentation</label><span className='demo-docs-hyperlink-icon'><img className={ sidebarMenuClicked ? "demo-docs-hyperlink-icon-sidebar-img" : ""} src='/assets/external_link_color.png' alt='no img available'/></span> for more information on adding and mapping attributes.</p>
                        ...
                        <div style={{width: sidebarMenuClicked ? "63%" : "auto", float: sidebarMenuClicked ? "right" : "none", marginBottom: sidebarMenuClicked ? "1%" : "4%", paddingBottom: sidebarMenuClicked ? "5%" : "5%", borderBottom: "1.3px solid #6363f1"}} className='demo-docs-section'>
                            ...
                            <div id='img698' className={`enlargable-image-container ${this.state.enlargedImageId === 'img698' ? 'enlarged' : ''}`} onClick={() => this.toggleEnlarged('img698')}>
                                    <img  src='/assets/shibbo_generic_img4.avif' alt="Enlargable" className="image" />
                            </div>

                            <p className={sidebarMenuClicked ? "demo-docs-section-sidebar-p" : ""}>Upload the XML metadata file from Shibboleth into the “Metadata File” field and select “Save Metadata Configuration”. Your connection will then be linked and good to go!</p>

                            <div id='img699' className={`enlargable-image-container ${this.state.enlargedImageId === 'img699' ? 'enlarged' : ''}`} onClick={() => this.toggleEnlarged('img699')}>
                                    <img  src='/assets/shibbo_generic_img5.avif' alt="Enlargable" className="image" />
                            </div>
                ...
                <CSSTransition in={shibbolethUnsolicited}
                timeout={500}
                classNames="docs-side-panel"
                unmountOnExit    
                >
